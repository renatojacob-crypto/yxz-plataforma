...
export const PERMISSIONS = {
  ...
  /*
   * GESTAO DE PECAS - ETAPA 2 (SOMENTE CONSULTA)
   */
  PECAS_VIEW:
    "pecas.visualizar",
...
/*
 * Operações disponíveis igualmente para Educador Social e Coordenador.
 * Permissões restritas NÃO entram nesta lista:
 * usuarios.gerenciar, relatorios.visualizar, pecas.gerenciar.
 * Novas permissões não são concedidas automaticamente.
 */
...
const ADMINISTRATIVE_PERMISSIONS = Object.freeze([
  PERMISSIONS.PECAS_MANAGE,
  PERMISSIONS.REPORTS_VIEW,
  PERMISSIONS.INSTRUCTOR_DASHBOARD,
]);

const PROFILE_PERMISSIONS = {
  // Gestão de usuários exige também pode_gerenciar_usuarios = true.
  [USER_PROFILES.MASTER]: new Set([
    ...OPERATIONAL_PERMISSIONS,
    ...ADMINISTRATIVE_PERMISSIONS,
    PERMISSIONS.USERS_MANAGE,
  ]),

  // Tudo que o Master faz, exceto gerir usuários.
  [USER_PROFILES.ADMIN]: new Set([
    ...OPERATIONAL_PERMISSIONS,
    ...ADMINISTRATIVE_PERMISSIONS,
  ]),

  // Mesmos acessos operacionais; sem usuários, relatórios,
  // faturamento, cadastro/gestão/separação e dashboard de peças.
  [USER_PROFILES.SOCIAL_EDUCATOR]: new Set(OPERATIONAL_PERMISSIONS),
  [USER_PROFILES.COORDINATOR]: new Set(OPERATIONAL_PERMISSIONS),

  [USER_PROFILES.INSTRUCTOR]: new Set([
    PERMISSIONS.PECAS_VIEW,
    PERMISSIONS.INSTRUCTOR_DASHBOARD,
  ]),
};
